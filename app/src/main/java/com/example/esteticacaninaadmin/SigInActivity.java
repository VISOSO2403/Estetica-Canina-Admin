            ...
            public void onClick(View view) {
                ...
                if (!nom.isEmpty() && !apell.isEmpty() && !mail.isEmpty() && !contra.isEmpty()){
                    if (contra.length() >= 6){
                        ...
                        Toast.makeText(SigInActivity.this, "La contraseña debe tener minimo 6 caracteres", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(SigInActivity.this, "Los campos no pueden estar vacios", Toast.LENGTH_SHORT).show();
                }
            }
                ...
                mAuth.createUserWithEmailAndPassword(mail, contra).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SigInActivity.this, "Nuevo trabajador registrado", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(SigInActivity.this, MenuActivity.class));
                            finish();
                        }else{
                            Toast.makeText(SigInActivity.this, "Trabajador no registrado", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
